...
void LoginWindow::on_login_clicked(){
    ...
    utilizator.setare_campuri(nume,pw);
        ...
        if(utilizator.trimite_datele_la_server()==0){
            ...
            if(utilizator.primeste_raspuns_de_la_server()==0){
                ...
                if(utilizator.este_autentificat()){
                    MainWindow *app = 0;
                    app = new MainWindow(0,utilizator.get_username());
                    //app = new MainWindow(utilizator.get_username());
                    app->show();
                    conexiuneaTrebuieInchisa = false;
                    this->close();
                }
                else{
